...
function App(){
  ...
  return <main className="app">
    ...
    <>
      {daily && guide && <section className="present">
        <div className="presentLead">
          <p className="eyebrow">THE PRESENT CHAPTER</p>
          <div className="presentTitleRow">
            <div>
          ...
          <p className="guideOpening">{guide.opening}</p>
        </div>
        <div className="oracleGrid">
          <article className="oracleCard emphasis">
            <span className="oracleNo">I</span><p className="eyebrow">WHAT IS STRONGEST</p>
            <h3>{guide.strongest.name}</h3><p>{guide.strength}</p>
          </article>
          <article className="oracleCard">
            <span className="oracleNo">II</span><p className="eyebrow">WHERE TO USE CARE</p>
            <h3>{guide.tender.name}</h3><p>{guide.caution}</p>
          </article>
          <article className="oracleCard">
            <span className="oracleNo">III</span><p className="eyebrow">THE COUNSEL</p>
            <h3>Act with proportion.</h3><p>{guide.practice}</p>
          </article>
        </div>
        <div className="ancientVoice">
          <div className="bust">✦</div>
          <div>
            <p className="eyebrow">THE ANCIENT LENS</p>
            <blockquote>“The year does not replace the nativity; it awakens a portion of it.”</blockquote>
            <p>This is a modern synthesis of the Hellenistic logic behind annual profections: the natal chart describes the field of possibility, while the profected place and its lord identify which part of that field is brought forward in a given year.</p>
            <details><summary>How this guidance was formed</summary>
              <div className="methodNotes">
                <span>1 · Annual profection selects the activated house.</span>
                <span>2 · Its sign identifies the Lord of the Year.</span>
                <span>3 · Today’s seven traditional planets are placed into your natal Whole Sign houses.</span>
                <span>4 · Benefic and malefic testimony is treated as context, not destiny.</span>
                <span>5 · The language above is interpretive synthesis, not a quotation from an ancient author.</span>
              </div>
            </details>
          </div>
        </div>
