...
import './styles.css'
import olympusOriginalPanel from 'src/assets/deities/olympus-original-panel-v2.png'
    ...
    <section className="olympusComic olympusIllustrated" aria-labelledby="olympus-comic-title">
      ...
      {olympusComic ? <>
        <div className="olympusArtworkFrame">
          <img src={olympusOriginalPanel} alt="Original Hellenistic Life illustrated three-panel scene on Olympus with Aphrodite, Jupiter and Hermes." />
