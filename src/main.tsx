...
function deitySourceLink(planet:string,tradition:DevotionalTradition){
  return DEITY_SOURCE_LINKS[tradition][planet as keyof typeof DEITY_SOURCE_LINKS.Hindu]
}
...
function dailyComic(transits:PlanetRow[],date:string,tradition:DevotionalTradition):OlympusComic{
  ...
  const scripts:Record<string,ComicBeat[][]>={
    conjunction:[[{speaker:A,line:'We appear to have the same appointment.'},{speaker:B,line:'Then we may as well make it consequential.'},{speaker:'Olympus',line:'Two forces. One doorway.'}]],
    sextile:[[{speaker:A,line:'I brought an opportunity.'},{speaker:B,line:'Convenient. I brought the missing piece.'},{speaker:'Olympus',line:'Cooperation, with divine paperwork.'}]],
    square:[[{speaker:A,line:'Move.'},{speaker:B,line:'No.'},{speaker:'Olympus',line:'And thus the character-building portion of the day begins.'}]],
    trine:[[{speaker:A,line:'That was easier than expected.'},{speaker:B,line:'Do not announce that too loudly.'},{speaker:'Olympus',line:'Grace is flowing. Use it before hubris notices.'}]],
    opposition:[[{speaker:A,line:'From here, you are clearly the problem.'},{speaker:B,line:'Fascinating. I was about to say the same.'},{speaker:'Olympus',line:'Perspective has entered the chat.'}]]
  }
      ...
      {olympusComic ? <>
        ...
        <div className="comicStrip">
          {olympusComic.beats.map((beat,i)=><article className={`comicPanel panel${i+1}`} key={`${beat.speaker}-${i}`}>
            ...
            <div className="comicClouds" aria-hidden="true"><i></i><i></i><i></i></div>
            <div className="comicFigure" aria-hidden="true"><span className="comicHead"></span><span className="comicBody"></span></div>
