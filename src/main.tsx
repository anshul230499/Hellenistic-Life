...
const PLANET_GUIDES:Record<string,{
  ...
  Sun:{
    Hindu:{name:'Surya',theme:'clarity, vitality, rightful visibility',image:'/deities/hindu/surya.png'},
    Greek:{name:'Helios',theme:'illumination, witness, conscious direction',image:'/deities/greek/helios.png'},
    Roman:{name:'Sol',theme:'radiance, authority, steadiness of purpose',image:'/deities/roman/sol.png'}
  },
  Moon:{
    Hindu:{name:'Chandra',theme:'mind, feeling, receptivity, rhythm',image:'/deities/hindu/chandra.png'},
    Greek:{name:'Selene',theme:'reflection, cycles, inner response',image:'/deities/greek/selene.png'},
    Roman:{name:'Luna',theme:'rhythm, memory, changing conditions',image:'/deities/roman/luna.png'}
  },
  Mercury:{
    Hindu:{name:'Budha',theme:'intelligence, speech, discernment, exchange',image:'/deities/hindu/budha.png'},
    Greek:{name:'Hermes',theme:'messages, crossings, negotiation, travel',image:'/deities/greek/hermes.png'},
    Roman:{name:'Mercury',theme:'communication, commerce, exchange, movement',image:'/deities/roman/mercury.png'}
  },
  Venus:{
    Hindu:{name:'Shukra',theme:'harmony, attraction, pleasure, reconciliation',image:'/deities/hindu/shukra.png'},
    Greek:{name:'Aphrodite',theme:'beauty, affection, attraction, accord',image:'/deities/greek/aphrodite.png'},
    Roman:{name:'Venus',theme:'relationship, grace, pleasure, social harmony',image:'/deities/roman/venus.png'}
  },
  Mars:{
    Hindu:{name:'Mangala',theme:'courage, discipline, force, decisive action',image:'/deities/hindu/mangala.png'},
    Greek:{name:'Ares',theme:'assertion, conflict, courage, force',image:'/deities/greek/ares.png'},
    Roman:{name:'Mars',theme:'discipline, defense, command, purposeful action',image:'/deities/roman/mars.png'}
  },
  Jupiter:{
    Hindu:{name:'Brihaspati',theme:'wisdom, counsel, teachers, right judgment',image:'/deities/hindu/brihaspati.png'},
    Greek:{name:'Zeus',theme:'authority, order, protection, expansive judgment',image:'/deities/greek/zeus.png'},
    Roman:{name:'Jupiter',theme:'law, blessing, authority, enlargement',image:'/deities/roman/jupiter.png'}
  },
  Saturn:{
    Hindu:{name:'Shani',theme:'endurance, karma, limits, patience, responsibility',image:'/deities/hindu/shani.png'},
    Greek:{name:'Kronos',theme:'time, limits, consequence, maturation',image:'/deities/greek/kronos.png'},
    Roman:{name:'Saturn',theme:'time, restraint, agriculture, mature order',image:'/deities/roman/saturn.png'}
  }
}
...
function deityImageFallback(e:React.SyntheticEvent<HTMLImageElement>,planet:string){
  ...
  const fallback:Record<string,string>={
    Sun:'/deities/hindu/surya.png',Moon:'/deities/hindu/chandra.png',Mercury:'/deities/hindu/budha.png',
    Venus:'/deities/hindu/shukra.png',Mars:'/deities/hindu/mangala.png',Jupiter:'/deities/hindu/brihaspati.png',Saturn:'/deities/hindu/shani.png'
  }
  img.src=fallback[planet]||'/deities/hindu/surya.png'
}
